                ...
                <div className="container mx-auto max-w-6xl px-4">
                    ...
                    <section className="mt-4 mb-10">
                        <button
                            ...
                            className="group relative flex w-full transform-gpu cursor-pointer flex-col justify-center overflow-hidden rounded-3xl border border-emerald-400/30 p-8 text-left text-white shadow-lg shadow-emerald-500/10 transition-all duration-300 select-none hover:scale-[1.008] hover:shadow-xl hover:shadow-emerald-500/18 active:scale-[0.99] md:p-10"
                            aria-label="Scan medicine"
                        >
                            <div className="absolute inset-0 z-0 bg-linear-to-tr from-emerald-700 via-emerald-600 to-teal-500"></div>
                    ...
                    <section className="mb-16">
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            <button
                                ...
                                className="group relative flex h-full min-h-[180px] w-full transform-gpu cursor-pointer flex-col justify-between overflow-hidden rounded-3xl border border-slate-200/50 bg-white/75 p-6 text-left shadow-sm backdrop-blur-md transition-all duration-300 select-none hover:-translate-y-1 hover:scale-[1.008] hover:border-blue-500/30 hover:shadow-md hover:shadow-blue-500/5 active:scale-[0.99] dark:border-slate-800/50 dark:bg-slate-900/55 dark:hover:border-blue-400/30 dark:hover:shadow-blue-400/5"
                                aria-label="Voice triage"
                            >
                                {/* Background Decorative Mesh & Glow */}
                                <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.08),transparent_72%)] opacity-0 transition-opacity duration-300 group-hover:opacity-100 dark:bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.14),transparent_72%)]"></div>
                            ...
                            <button
                                ...
                                className="group relative flex h-full min-h-[180px] w-full transform-gpu cursor-pointer flex-col justify-between overflow-hidden rounded-3xl border border-slate-200/50 bg-white/75 p-6 text-left shadow-sm backdrop-blur-md transition-all duration-300 select-none hover:-translate-y-1 hover:scale-[1.008] hover:border-amber-500/30 hover:shadow-md hover:shadow-amber-500/5 active:scale-[0.99] dark:border-slate-800/50 dark:bg-slate-900/55 dark:hover:border-amber-400/30 dark:hover:shadow-amber-400/5"
                                aria-label="Pharmacy map"
                            >
                                {/* Background Decorative Mesh & Glow */}
                                <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(245,158,11,0.08),transparent_72%)] opacity-0 transition-opacity duration-300 group-hover:opacity-100 dark:bg-[radial-gradient(circle_at_top,rgba(245,158,11,0.14),transparent_72%)]"></div>
                            ...
                            <button
                                ...
                                className="group relative flex h-full min-h-[180px] w-full transform-gpu cursor-pointer flex-col justify-between overflow-hidden rounded-3xl border border-slate-200/50 bg-white/75 p-6 text-left shadow-sm backdrop-blur-md transition-all duration-300 select-none hover:-translate-y-1 hover:scale-[1.008] hover:border-red-500/30 hover:shadow-md hover:shadow-red-500/5 active:scale-[0.99] dark:border-slate-800/50 dark:bg-slate-900/55 dark:hover:border-red-400/30 dark:hover:shadow-red-400/5"
                                aria-label="Report fake medicine"
                            >
                                {/* Background Decorative Mesh & Glow */}
                                <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(239,68,68,0.08),transparent_72%)] opacity-0 transition-opacity duration-300 group-hover:opacity-100 dark:bg-[radial-gradient(circle_at_top,rgba(239,68,68,0.14),transparent_72%)]"></div>
                    ...
                    <div
                        className="group relative mt-4 transform-gpu overflow-hidden rounded-3xl shadow-lg shadow-purple-500/8 transition-all duration-300 select-none hover:scale-[1.008] hover:shadow-xl hover:shadow-purple-500/12"
                        style={{
                            background:
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-start gap-5 p-6 sm:flex-row sm:items-center sm:justify-between sm:gap-6 sm:p-8">
                            <div className="flex items-start gap-3.5 sm:items-center sm:gap-4">
                                ...
                                <div className="space-y-1 max-[390px]:space-y-1.5">
                                    ...
                                    <p className="text-sm leading-relaxed font-medium text-purple-100 sm:text-base max-[390px]:text-[0.95rem] max-[390px]:leading-snug">
                            ...
                            <button
                                ...
                                className="group/btn flex w-full shrink-0 items-center justify-center gap-2.5 rounded-xl border-2 border-white/80 bg-white/15 px-7 py-3 text-base font-bold text-white backdrop-blur-sm transition-all duration-300 hover:bg-white hover:text-purple-700 hover:shadow-lg hover:shadow-purple-900/15 sm:w-auto"
                            >
                    ...
                    <div className="mt-12 mb-16 md:mt-10">
                        <div className="flex flex-col overflow-hidden rounded-3xl border border-slate-200/50 bg-white/70 shadow-sm shadow-slate-950/5 backdrop-blur-md dark:border-slate-800/50 dark:bg-slate-900/50">
